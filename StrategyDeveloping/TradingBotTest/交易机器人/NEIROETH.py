...
####如果要重跑代码就把下面两个参数改成最新的
priceRecord =  0.1497
positions = [
            {'rate': 0.1497, 'amount': 33.199, 'sold': 0},
            {'rate': 0.1568, 'amount': 31.682, 'sold': 0},
            {'rate': 0.1557, 'amount': 31.905, 'sold': 0},
            {'rate': 0.1604, 'amount': 30.973, 'sold': 0},
            {'rate': 0.1462, 'amount': 26, 'sold': 0}
             ]
