...
def main():
    ...
    symbol = "CAKEUSDT"
    filename = "CAKE_30m_2024.10-2025.10.csv"
    interval = "30m"
    limit = 1  # 只取最新一根K线
    while True:
           ...
           ### print("写入新k线" + str(k_data))
            ...
            with (open('CAKE_30m_2024.10-2025.10.csv', newline='', encoding='utf-8') as csvfile1,
                  open('CAKE_4h_2024.10-2025.10.csv', newline='', encoding='utf-8') as csvfile2):
